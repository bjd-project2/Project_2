  ...
  d3.csv("species_count1.csv", function(error, countData) {
    ...
    countData.forEach(function(data) {
      ...
      data.Spider_Scorpion = +data.Spider_Scorpion
    ...
    var line2 = d3.line()
      ...
      .y(d => yLinearScale1(d.Spider_Scorpion/2));
    ...
    //
          ...
          // Step 5: Create Circles
              ...
              // function(d) { return x(d.date); })
                .attr("cy",function(d) { return yLinearScale1(d.Spider_Scorpion/2); })
...
//     // ==============================
    var toolTip = d3.tip()
      ...
      .offset([80, -60])
      .html(function(d) {
        return (`${d.park_name}<br>Species, Spider_Scorpion: ${d.Spider_Scorpion}`);
      });
   ...
   // Create axes labels
    chartGroup.append("text")
      ...
      .attr("dy", "1em")
      .attr("class", "axisText")
      .text("Number Of Spider_Scorpion Species At Each Park");
